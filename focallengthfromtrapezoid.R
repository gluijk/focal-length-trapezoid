...
get_aspectratio_focallength_FOV <- function(width, height, x, y) {
    ...
    # which for a normal camera will be the center of the image: i.e. u0=IMAGEWIDTH/2, v0 =IMAGEHEIGHT/2
...
# Panasonic S1R con 14-28mm a 14mm → 14,60mm estimados
width=1920; height=1281
